...
The packages in the `yaml_cpp_vendor` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy yaml_cpp_vendor --override-release-repository-push-url git@github.com:revyos-ros/yaml_cpp_vendor-release.git` on `Thu, 13 Jun 2024 03:33:17 -0000`
...
- release repository: https://github.com/revyos-ros/yaml_cpp_vendor-release.git
